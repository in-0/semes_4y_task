...
# Fusion 모델 (기본)
python train.py --num_epochs 100 --batch_size 64 --data sms --lr 0.001 --moco_k 1024 --moco_m 0.99 --moco_t 0.07 --use_cb --use_paco --use_dim_matching_layer --save_path ./results_4y --comment sms_fusion_matching_dim_layer_moco_k_1024_m_0.99_t_0.07_lr_0.001_epoch_100_batch_64
